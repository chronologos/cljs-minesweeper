var CLOSURE_UNCOMPILED_DEFINES = {"figwheel.repl.connect_url":"ws:\/\/localhost:9500\/figwheel-connect?fwprocess=8111b3&fwbuild=test"};
...
document.write('<script>goog.require("minesweeper.test_runner");</script>');
