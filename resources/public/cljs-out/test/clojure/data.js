...
return cljs.core.reduce.call(null,(function (result,p__12486){
...
var vec__12490 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__12490,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__12490,(1),null);
var ab = cljs.core.nth.call(null,vec__12490,(2),null);
...
return (function (){var G__12499 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__12499__$1)].join('')));
