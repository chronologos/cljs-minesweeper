...
var G__13342 = o;
(G__13342[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__13346 = o;
(G__13346[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__13347__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
return G__13347__delegate.call(this,args);};
...
return G__13347__delegate(args);
});
...
var G__13351 = props;
var G__13351__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__13351,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__13351);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__13351__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__13352){
...
var props = map__13353__$1;
var class$ = cljs.core.get.call(null,map__13353__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__13353,map__13353__$1,props,class$){
return (function (c){
...
});})(map__13353,map__13353__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__13355){
...
var on_write = cljs.core.get.call(null,map__13356__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__13356,map__13356__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__13356,map__13356__$1,on_write))
);
} else {
...
(G__13359["defaultValue"] = value);

(G__13359["onChange"] = ((function (G__13359,v,value,on_change){
return (function (p1__13358_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__13358_SHARP_);
});})(G__13359,v,value,on_change))
);
...
var vec__13362 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__13362,(0),null);
var id = cljs.core.nth.call(null,vec__13362,(1),null);
var class$ = cljs.core.nth.call(null,vec__13362,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___13366 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___13366 == null)){
} else {
var key_13367 = temp__5461__auto___13366;
...
var temp__5461__auto___13368 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___13368 == null)){
} else {
var key_13369 = temp__5461__auto___13368;
reagent.impl.template.oset.call(null,jsprops,"key",key_13369);
}
...
var G__13370 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__13370["name"] = c);
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq13374){
...
break;
default:
var G__13381 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__13381;
continue;
...
var n__4607__auto___13383 = a.length;
var i_13384 = (0);
while(true){
if((i_13384 < n__4607__auto___13383)){
(a[i_13384] = reagent.impl.template.as_element.call(null,(a[i_13384])));
...
var a = cljs.core.into_array.call(null,s);
var n__4607__auto___13386 = a.length;
var i_13387 = (0);
while(true){
if((i_13387 < n__4607__auto___13386)){
var val_13388 = (a[i_13387]);
if(((cljs.core.vector_QMARK_.call(null,val_13388)) && ((reagent.impl.template.key_from_vec.call(null,val_13388) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_13387] = reagent.impl.template.as_element.call(null,val_13388));
...
var ctx = ({});
var vec__13390 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__13390,(0),null);
var derefed = cljs.core.nth.call(null,vec__13390,(1),null);
...
var G__13393 = (cljs.core.count.call(null,argv) - first_child);
switch (G__13393) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__13393){
