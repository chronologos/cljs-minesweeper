...
var G__13975 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__13975,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__13975;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq13977){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13978,G__13979,seq13977__$2);
});
...
var file = cljs.core.get.call(null,map__13984__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__13984__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__13984__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__13984,map__13984__$1,file,line,column){
return (function (p1__13983_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__13983_SHARP_));
});})(map__13984,map__13984__$1,file,line,column))
...
var temp__5457__auto___13986 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___13986)){
var message_13987 = temp__5457__auto___13986;
cljs.core.println.call(null,message_13987);
} else {
}
...
var temp__5457__auto___13988 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___13988)){
var message_13989 = temp__5457__auto___13988;
cljs.core.println.call(null,message_13989);
} else {
}
...
var output_dir__$1 = (function (){var G__13990 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__13990,"/"].join('');
} else {
return G__13990;
}
})();
...
var G__13992 = exception.stack;
var G__13992__$1 = (((G__13992 == null))?null:clojure.string.split_lines.call(null,G__13992));
var G__13992__$2 = (((G__13992__$1 == null))?null:cljs.core.get.call(null,G__13992__$1,depth));
if((G__13992__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__13992__$2);
}
} else {
...
var vec__13993 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__13993,(0),null);
var column = cljs.core.nth.call(null,vec__13993,(1),null);
var vec__13996 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__13996,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__13996,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__13996,(2),null);
...
var m__$1 = (function (){var G__13999 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__14003 = (function (){var G__14002 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__14002);
} else {
return G__14002;
}
})();
...
return cljs.core.vary_meta.call(null,G__14004,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e14005){var e = e14005;
var G__14006 = e;
var G__14006__$1 = (((G__14006 instanceof cljs.core.Keyword))?G__14006.fqn:null);
switch (G__14006__$1) {
...
var vec__14008 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__14008,(0),null);
var types = vec__14008;
...
return cljs.core.map.call(null,(function (p__14011){
var vec__14012 = p__14011;
var ns = cljs.core.nth.call(null,vec__14012,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__14012,(1),null);
return ((function (vec__14012,ns,vars__$1){
return (function (){
...
var G__14015 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__14015,G__14015__$1,env,once_fixtures,each_fixtures,vec__14012,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__14015,G__14015__$1,env,once_fixtures,each_fixtures,vec__14012,ns,vars__$1){
return (function (){
var seq__14016 = cljs.core.seq.call(null,vars__$1);
var chunk__14017 = null;
var count__14018 = (0);
var i__14019 = (0);
while(true){
if((i__14019 < count__14018)){
var v = cljs.core._nth.call(null,chunk__14017,i__14019);
var temp__5457__auto___14021 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___14021)){
var t_14022 = temp__5457__auto___14021;
each_fixture_fn.call(null,((function (seq__14016,chunk__14017,count__14018,i__14019,t_14022,temp__5457__auto___14021,v,each_fixture_fn,G__14015,G__14015__$1,env,once_fixtures,each_fixtures,vec__14012,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_14022)));
});})(seq__14016,chunk__14017,count__14018,i__14019,t_14022,temp__5457__auto___14021,v,each_fixture_fn,G__14015,G__14015__$1,env,once_fixtures,each_fixtures,vec__14012,ns,vars__$1))
);
} else {
}


var G__14023 = seq__14016;
var G__14024 = chunk__14017;
var G__14025 = count__14018;
var G__14026 = (i__14019 + (1));
seq__14016 = G__14023;
chunk__14017 = G__14024;
count__14018 = G__14025;
i__14019 = G__14026;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__14016);
if(temp__5457__auto__){
var seq__14016__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__14016__$1)){
var c__4550__auto__ = cljs.core.chunk_first.call(null,seq__14016__$1);
var G__14027 = cljs.core.chunk_rest.call(null,seq__14016__$1);
var G__14028 = c__4550__auto__;
var G__14029 = cljs.core.count.call(null,c__4550__auto__);
var G__14030 = (0);
seq__14016 = G__14027;
chunk__14017 = G__14028;
count__14018 = G__14029;
i__14019 = G__14030;
continue;
} else {
var v = cljs.core.first.call(null,seq__14016__$1);
var temp__5457__auto___14031__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___14031__$1)){
var t_14032 = temp__5457__auto___14031__$1;
each_fixture_fn.call(null,((function (seq__14016,chunk__14017,count__14018,i__14019,t_14032,temp__5457__auto___14031__$1,v,seq__14016__$1,temp__5457__auto__,each_fixture_fn,G__14015,G__14015__$1,env,once_fixtures,each_fixtures,vec__14012,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_14032)));
});})(seq__14016,chunk__14017,count__14018,i__14019,t_14032,temp__5457__auto___14031__$1,v,seq__14016__$1,temp__5457__auto__,each_fixture_fn,G__14015,G__14015__$1,env,once_fixtures,each_fixtures,vec__14012,ns,vars__$1))
);
} else {
}


var G__14033 = cljs.core.next.call(null,seq__14016__$1);
var G__14034 = null;
var G__14035 = (0);
var G__14036 = (0);
seq__14016 = G__14033;
chunk__14017 = G__14034;
count__14018 = G__14035;
i__14019 = G__14036;
continue;
}
} else {
...
});})(each_fixture_fn,G__14015,G__14015__$1,env,once_fixtures,each_fixtures,vec__14012,ns,vars__$1))
);
});})(each_fixture_fn,G__14015,G__14015__$1,env,once_fixtures,each_fixtures,vec__14012,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14015__$1)].join('')));

}
})());
});
;})(vec__14012,ns,vars__$1))
