...
var G__12401 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__12401,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__12401;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq12403){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12404,G__12405,seq12403__$2);
});
...
var map__12410 = m;
var map__12410__$1 = (((((!((map__12410 == null))))?(((((map__12410.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__12410.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__12410):map__12410);
var file = cljs.core.get.call(null,map__12410__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__12410__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__12410__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__12410,map__12410__$1,file,line,column){
return (function (p1__12409_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__12409_SHARP_));
});})(map__12410,map__12410__$1,file,line,column))
...
var temp__5457__auto___12412 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___12412)){
var message_12413 = temp__5457__auto___12412;
cljs.core.println.call(null,message_12413);
} else {
}
...
var temp__5457__auto___12414 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___12414)){
var message_12415 = temp__5457__auto___12414;
cljs.core.println.call(null,message_12415);
} else {
}
...
var output_dir__$1 = (function (){var G__12416 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__12416,"/"].join('');
} else {
return G__12416;
}
})();
...
var G__12418 = exception.stack;
var G__12418__$1 = (((G__12418 == null))?null:clojure.string.split_lines.call(null,G__12418));
var G__12418__$2 = (((G__12418__$1 == null))?null:cljs.core.get.call(null,G__12418__$1,depth));
if((G__12418__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__12418__$2);
}
} else {
...
var vec__12419 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__12419,(0),null);
var column = cljs.core.nth.call(null,vec__12419,(1),null);
var vec__12422 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__12422,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__12422,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__12422,(2),null);
...
var m__$1 = (function (){var G__12425 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__12429 = (function (){var G__12428 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__12428);
} else {
return G__12428;
}
})();
...
return cljs.core.vary_meta.call(null,G__12430,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__12434 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__12434,(0),null);
var types = vec__12434;
...
return cljs.core.map.call(null,(function (p__12437){
var vec__12438 = p__12437;
var ns = cljs.core.nth.call(null,vec__12438,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__12438,(1),null);
return ((function (vec__12438,ns,vars__$1){
return (function (){
...
var G__12441 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__12441,G__12441__$1,env,once_fixtures,each_fixtures,vec__12438,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__12441,G__12441__$1,env,once_fixtures,each_fixtures,vec__12438,ns,vars__$1){
return (function (){
var seq__12442 = cljs.core.seq.call(null,vars__$1);
var chunk__12443 = null;
var count__12444 = (0);
var i__12445 = (0);
while(true){
if((i__12445 < count__12444)){
var v = cljs.core._nth.call(null,chunk__12443,i__12445);
var temp__5457__auto___12447 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___12447)){
var t_12448 = temp__5457__auto___12447;
each_fixture_fn.call(null,((function (seq__12442,chunk__12443,count__12444,i__12445,t_12448,temp__5457__auto___12447,v,each_fixture_fn,G__12441,G__12441__$1,env,once_fixtures,each_fixtures,vec__12438,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_12448)));
});})(seq__12442,chunk__12443,count__12444,i__12445,t_12448,temp__5457__auto___12447,v,each_fixture_fn,G__12441,G__12441__$1,env,once_fixtures,each_fixtures,vec__12438,ns,vars__$1))
);
} else {
}


var G__12449 = seq__12442;
var G__12450 = chunk__12443;
var G__12451 = count__12444;
var G__12452 = (i__12445 + (1));
seq__12442 = G__12449;
chunk__12443 = G__12450;
count__12444 = G__12451;
i__12445 = G__12452;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__12442);
if(temp__5457__auto__){
var seq__12442__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__12442__$1)){
var c__4550__auto__ = cljs.core.chunk_first.call(null,seq__12442__$1);
var G__12453 = cljs.core.chunk_rest.call(null,seq__12442__$1);
var G__12454 = c__4550__auto__;
var G__12455 = cljs.core.count.call(null,c__4550__auto__);
var G__12456 = (0);
seq__12442 = G__12453;
chunk__12443 = G__12454;
count__12444 = G__12455;
i__12445 = G__12456;
continue;
} else {
var v = cljs.core.first.call(null,seq__12442__$1);
var temp__5457__auto___12457__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___12457__$1)){
var t_12458 = temp__5457__auto___12457__$1;
each_fixture_fn.call(null,((function (seq__12442,chunk__12443,count__12444,i__12445,t_12458,temp__5457__auto___12457__$1,v,seq__12442__$1,temp__5457__auto__,each_fixture_fn,G__12441,G__12441__$1,env,once_fixtures,each_fixtures,vec__12438,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_12458)));
});})(seq__12442,chunk__12443,count__12444,i__12445,t_12458,temp__5457__auto___12457__$1,v,seq__12442__$1,temp__5457__auto__,each_fixture_fn,G__12441,G__12441__$1,env,once_fixtures,each_fixtures,vec__12438,ns,vars__$1))
);
} else {
}


var G__12459 = cljs.core.next.call(null,seq__12442__$1);
var G__12460 = null;
var G__12461 = (0);
var G__12462 = (0);
seq__12442 = G__12459;
chunk__12443 = G__12460;
count__12444 = G__12461;
i__12445 = G__12462;
continue;
}
} else {
...
});})(each_fixture_fn,G__12441,G__12441__$1,env,once_fixtures,each_fixtures,vec__12438,ns,vars__$1))
);
});})(each_fixture_fn,G__12441,G__12441__$1,env,once_fixtures,each_fixtures,vec__12438,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__12441__$1)].join('')));

}
})());
});
;})(vec__12438,ns,vars__$1))
