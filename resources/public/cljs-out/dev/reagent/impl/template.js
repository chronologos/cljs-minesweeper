...
var G__10749 = o;
(G__10749[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__10751__i < G__10751__a.length) {G__10751__a[G__10751__i] = arguments[G__10751__i + 0]; ++G__10751__i;}
  args = new cljs.core.IndexedSeq(G__10751__a,0,null);
} 
...
var G__10753 = o;
(G__10753[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__10755__i < G__10755__a.length) {G__10755__a[G__10755__i] = arguments[G__10755__i + 0]; ++G__10755__i;}
  args = new cljs.core.IndexedSeq(G__10755__a,0,null);
} 
...
var G__10758 = props;
var G__10758__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__10758,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__10758);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__10758__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__10759){
...
var props = map__10760__$1;
var class$ = cljs.core.get.call(null,map__10760__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__10760,map__10760__$1,props,class$){
return (function (c){
...
});})(map__10760,map__10760__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__10762){
var map__10763 = p__10762;
var map__10763__$1 = (((((!((map__10763 == null))))?(((((map__10763.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10763.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__10763):map__10763);
var on_write = cljs.core.get.call(null,map__10763__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__10763,map__10763__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__10763,map__10763__$1,on_write))
);
} else {
...
var G__10766 = jsprops;
(G__10766["defaultValue"] = value);

(G__10766["onChange"] = ((function (G__10766,v,value,on_change){
return (function (p1__10765_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__10765_SHARP_);
});})(G__10766,v,value,on_change))
);
...
var vec__10769 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__10769,(0),null);
var id = cljs.core.nth.call(null,vec__10769,(1),null);
var class$ = cljs.core.nth.call(null,vec__10769,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___10773 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___10773 == null)){
} else {
var key_10774 = temp__5461__auto___10773;
(jsprops["key"] = key_10774);
}
...
var temp__5461__auto___10775 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___10775 == null)){
} else {
var key_10776 = temp__5461__auto___10775;
reagent.impl.template.oset.call(null,jsprops,"key",key_10776);
}
...
var G__10777 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__10777["name"] = c);
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq10781){
var G__10782 = cljs.core.first.call(null,seq10781);
var seq10781__$1 = cljs.core.next.call(null,seq10781);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10782,seq10781__$1);
});
...
break;
default:
var G__10788 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__10788;
continue;
...
var n__4607__auto___10790 = a.length;
var i_10791 = (0);
while(true){
if((i_10791 < n__4607__auto___10790)){
(a[i_10791] = reagent.impl.template.as_element.call(null,(a[i_10791])));
...
var a = cljs.core.into_array.call(null,s);
var n__4607__auto___10793 = a.length;
var i_10794 = (0);
while(true){
if((i_10794 < n__4607__auto___10793)){
var val_10795 = (a[i_10794]);
if(((cljs.core.vector_QMARK_.call(null,val_10795)) && ((reagent.impl.template.key_from_vec.call(null,val_10795) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_10794] = reagent.impl.template.as_element.call(null,val_10795));
...
var ctx = ({});
var vec__10797 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__10797,(0),null);
var derefed = cljs.core.nth.call(null,vec__10797,(1),null);
...
var G__10800 = (cljs.core.count.call(null,argv) - first_child);
switch (G__10800) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__10800){
