...
if((i < len)){
var k = (ks[i]);
var G__10691 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__10692 = (i + (1));
m = G__10691;
i = G__10692;
continue;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__10694 = c;
var G__10694__$1 = (((G__10694 == null))?null:G__10694.prototype);
if((G__10694__$1 == null)){
return null;
} else {
return (G__10694__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__10696 = c;
var G__10696__$1 = (((G__10696 == null))?null:G__10696.prototype);
if((G__10696__$1 == null)){
return null;
} else {
return (G__10696__$1["render"]);
}
})() == null)))));
});
...
while (G__10700__i < G__10700__a.length) {G__10700__a[G__10700__i] = arguments[G__10700__i + 0]; ++G__10700__i;}
  args = new cljs.core.IndexedSeq(G__10700__a,0,null);
} 
...
var _STAR_current_component_STAR__orig_val__10703 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__10704 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__10704;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__10703;
}});
...
return ((function (G__10705,G__10705__$1){
...
var c = this;
var G__10710_10712 = (c["cljsRatom"]);
if((G__10710_10712 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__10710_10712);
}
...
var renders_10714 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_10715 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_10714));
if((cljs.core.count.call(null,renders_10714) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_10714))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_10715)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.call(null,render_fun_10715)].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__10713 = name;
switch (G__10713) {
case "":
...
var G__10717 = o;
(G__10717[cljs.core.name.call(null,k)] = v);
...
var name = (function (){var G__10718 = fiber;
var G__10718__$1 = (((G__10718 == null))?null:(G__10718["type"]));
if((G__10718__$1 == null)){
return null;
} else {
return (G__10718__$1["displayName"]);
}
})();
var parent = (function (){var G__10719 = fiber;
if((G__10719 == null)){
return null;
} else {
return (G__10719["return"]);
}
})();
var path = (function (){var G__10720 = parent;
var G__10720__$1 = (((G__10720 == null))?null:reagent.impl.component.fiber_component_path.call(null,G__10720));
if((G__10720__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10720__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__4131__auto__ = (function (){var G__10722 = c;
if((G__10722 == null)){
return null;
} else {
return (G__10722["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__10723._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__10725 = c;
if((G__10725 == null)){
return null;
} else {
return (G__10725["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__10727 = c;
if((G__10727 == null)){
return null;
} else {
return G__10727._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4131__auto__ = (function (){var G__10729 = instance;
if((G__10729 == null)){
return null;
} else {
return (G__10729["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__10730 = instance;
if((G__10730 == null)){
return null;
} else {
return G__10730._currentElement;
}
}
})();
var name = (function (){var G__10731 = elem;
var G__10731__$1 = (((G__10731 == null))?null:(G__10731["type"]));
if((G__10731__$1 == null)){
return null;
} else {
return (G__10731__$1["displayName"]);
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__10733 = elem;
if((G__10733 == null)){
return null;
} else {
return (G__10733["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__10734._owner;
}
}
})();
var path = (function (){var G__10735 = owner;
var G__10735__$1 = (((G__10735 == null))?null:reagent.impl.component.component_path.call(null,G__10735));
if((G__10735__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10735__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_.call(null,res)){
...
var G__10736 = c;
var G__10736__$1 = (((G__10736 == null))?null:G__10736.constructor);
if((G__10736__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__10736__$1);
}
}
})();
