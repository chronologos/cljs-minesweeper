...
return html_coll.item(p1__12680_SHARP_);
...
return cljs.core._EQ_.call(null,"icon",p1__12681_SHARP_);
...
var ctx_12682 = cvs.getContext("2d");
ctx_12682.fillStyle = color;

ctx_12682.fillRect((0),(0),size,size);
