...
return cljs.core.reduce.call(null,(function (result,p__12676){
...
var vec__12680 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__12680,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__12680,(1),null);
var ab = cljs.core.nth.call(null,vec__12680,(2),null);
...
return (function (){var G__12689 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__12689__$1)].join('')));
