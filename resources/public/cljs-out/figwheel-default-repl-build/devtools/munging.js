...
var o11174 = temp__5455__auto__;
var temp__5455__auto____$1 = (o11174["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o11175 = temp__5455__auto____$1;
return (o11175["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__10535__auto__ = f;
return (o__10535__auto__["toString"]).call(o__10535__auto__);
} else {
return "";
}
}catch (e11176){var _ = e11176;
return "";
}});
...
try{var o__10535__auto___11178 = t;
(o__10535__auto___11178["cljs$lang$ctorPrWriter"]).call(o__10535__auto___11178,t,writer);
}catch (e11177){var __11179 = e11177;
}
...
var char_code = (function (){var o__10535__auto__ = (new String(char$));
return (o__10535__auto__["charCodeAt"]).call(o__10535__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__10535__auto__ = String;
return (o__10535__auto__["fromCharCode"]).call(o__10535__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__11180 = num_code;
switch (G__11180) {
case (1):
return (185);
...
var o__10535__auto__ = String;
return (o__10535__auto__["fromCharCode"]).call(o__10535__auto__,superscript_code);
});
/**
...
}catch (e11182){var _e__10542__auto__ = e11182;
return false;
}})())){
...
var vec__11183 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__11183,(0),null);
...
var temp__5455__auto____$1 = (o11186["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o11187 = temp__5455__auto____$1;
return (o11187["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__11190){
var vec__11191 = p__11190;
var ns_detector = cljs.core.nth.call(null,vec__11191,(0),null);
...
var G__11197 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__11198 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__11197;
remaining_tokens = G__11198;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq11188){
var G__11189 = cljs.core.first.call(null,seq11188);
var seq11188__$1 = cljs.core.next.call(null,seq11188);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11189,seq11188__$1);
});
...
var vec__11202 = cljs.core.split_with.call(null,(function (p1__11201_SHARP_){
return cljs.core.not_EQ_.call(null,p1__11201_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__11202,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__11202,(1),null);
...
var vec__11208 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__11208,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__11208,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__11211 = cljs.core.rest.call(null,remaining_tokens);
var G__11212 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__11211;
name_tokens = G__11212;
continue;
} else {
...
var vec__11215 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__11215,(0),null);
var arity = cljs.core.nth.call(null,vec__11215,(1),null);
var vec__11218 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__11218,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__11218,(1),null);
var vec__11221 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__11221,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__11221,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__11221,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__11221,(3),null);
...
var vec__11227 = result;
var munged_ns = cljs.core.nth.call(null,vec__11227,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__11227,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__11227,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__11227,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__11227,(4),null);
var arity = cljs.core.nth.call(null,vec__11227,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__11231 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__11231,(0),null);
var args = cljs.core.nth.call(null,vec__11231,(1),null);
var vec__11234 = devtools.munging.break_and_demunge_name.call(null,munged_name);
...
var G__11237 = (arity + (1));
var G__11238 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__11239){
var vec__11240 = p__11239;
var arity = cljs.core.nth.call(null,vec__11240,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__11240,(1),null);
...
return cljs.core.get.call(null,arities,p1__11243_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__11244_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___11251 = arguments.length;
var i__4731__auto___11252 = (0);
while(true){
if((i__4731__auto___11252 < len__4730__auto___11251)){
args__4736__auto__.push((arguments[i__4731__auto___11252]));

var G__11253 = (i__4731__auto___11252 + (1));
i__4731__auto___11252 = G__11253;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__11247){
var vec__11248 = p__11247;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__11248,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq11245){
var G__11246 = cljs.core.first.call(null,seq11245);
var seq11245__$1 = cljs.core.next.call(null,seq11245);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11246,seq11245__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__11256__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__11256__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__11256__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__11256__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__11257 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__11257,(0),null);
var fn_name = cljs.core.nth.call(null,vec__11257,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__11257,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__11257,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__11257,(4),null);
var arity = cljs.core.nth.call(null,vec__11257,(5),null);
...
var o__10535__auto__ = f;
return (o__10535__auto__["getBasis"]).call(o__10535__auto__);
});
/**
...
}catch (e11261){var _e__10542__auto__ = e11261;
...
var G__11262 = (obj[cljs.core.first.call(null,path)]);
var G__11263 = cljs.core.rest.call(null,path);
obj = G__11262;
path = G__11263;
continue;
} else {
...
return (function (accum,p__11264){
var vec__11265 = p__11264;
var bit = cljs.core.nth.call(null,vec__11265,(0),null);
var protocol = cljs.core.nth.call(null,vec__11265,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__11268){
...
var selector = cljs.core.nth.call(null,vec__11269,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__11274,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__11274,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__11274,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__11272_SHARP_){
return (obj[cljs.core.first.call(null,p1__11272_SHARP_)]);
});})(name,sorted_matches,vec__11274,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
