...
var G__11279 = devtools.prefs.pref.call(null,v);
v = G__11279;
continue;
} else {
return v;
...
}catch (e11282){var _e__10542__auto__ = e11282;
return false;
}})();
...
}catch (e11286){var _e__10542__auto__ = e11286;
return false;
}})();
...
}catch (e11288){var _e__10542__auto__ = e11288;
return false;
}}
}
});
...
var vec__11290 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__11290,(0),null);
var name = cljs.core.nth.call(null,vec__11290,(1),null);
...
return cljs.core.some.call(null,(function (p1__11293_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__11293_SHARP_);
}),template);
});
